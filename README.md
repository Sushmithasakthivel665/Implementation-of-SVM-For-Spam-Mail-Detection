...
data = pd.read_csv("C:/Users/Sushmitha/Downloads/spam.csv", encoding="latin-1")
data = data[['v1', 'v2']]
...
## Output:
<img width="601" height="396" alt="Screenshot 2026-05-22 111126" src="https://github.com/user-attachments/assets/bea7fdff-1085-4691-b42d-ede301e0a729" />
